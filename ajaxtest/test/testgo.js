...
go$packages["main"] = (function() {
	var go$pkg = {}, js = go$packages["github.com/gopherjs/gopherjs/js"], jquery = go$packages["github.com/gopherjs/jquery"], Object, main, jQuery;
	Object = go$pkg.Object = go$newType(0, "Map", "main.Object", "Object", "main", null);
	main = go$pkg.main = function() {
		jQuery(new (go$sliceType(go$emptyInterface))([new Go$String("#btnGopherJS")])).On(new (go$sliceType(go$emptyInterface))([new Go$String("click"), new (go$funcType([], [], false))((function() {
			var showConsole, _map, _key, ajaxopt;
			showConsole = jQuery(new (go$sliceType(go$emptyInterface))([new Go$String("input[name='console']")])).Is(new (go$sliceType(go$emptyInterface))([new Go$String(":checked")]));
			if (showConsole) {
				console.log("GoperJS here");
			}
			ajaxopt = (_map = new Go$Map(), _key = "async", _map[_key] = { k: _key, v: new Go$Bool(true) }, _key = "type", _map[_key] = { k: _key, v: new Go$String("GET") }, _key = "url", _map[_key] = { k: _key, v: new Go$String("http://localhost:3000/") }, _key = "contentType", _map[_key] = { k: _key, v: new Go$String("application/json; charset=utf-8") }, _key = "dataType", _map[_key] = { k: _key, v: new Go$String("json") }, _key = "data", _map[_key] = { k: _key, v: null }, _key = "beforeSend", _map[_key] = { k: _key, v: new (go$funcType([Object], [], false))((function(data) {
				if (showConsole) {
				...
				dataStr = go$internalize(go$global.JSON.stringify(go$externalize(data, Object)), Go$String);
